...
vg_lite_error_t vg_lite_test_fill(struct gpu_test_context_s *ctx)
{
...
vg_lite_error_t vg_lite_test_blit(struct gpu_test_context_s *ctx)
{
  vg_lite_error_t error = VG_LITE_SUCCESS;
...
vg_lite_error_t vg_lite_test_global_alpha(struct gpu_test_context_s *ctx)
{
  vg_lite_error_t error = VG_LITE_SUCCESS;
  vg_lite_matrix_t matrix;
